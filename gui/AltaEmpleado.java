...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta acción borrara los datos actuales. ¿Estás seguro de continuar?");
        if (respuesta == 0) {
            // leer el archivo
...
//falta hacer control de tamaño
    ...
    private void llenarFormulario(int indice) {
        if (lista.size() > 0) {
            ...
            this.jTextField12.setText(e.getApPaterno());
